...
from .views import TennisListView, TennisDetailView, TennisCreateView, TennisUpdateView, TennisDeleteView
from . import views
...
urlpatterns = [
    ...
    path('tennis/schedule', views.tennisScheduleView, name='schedule-tennis'),
]